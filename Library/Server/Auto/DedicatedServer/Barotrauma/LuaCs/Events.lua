...
---@class Barotrauma.LuaCs.Events.IEventModifyChatMessage: Barotrauma.LuaCs.Events.IEvent
CS.Barotrauma.LuaCs.Events.IEventModifyChatMessage = {}

---@param message Barotrauma.Networking.ChatMessage
---@param senderRadio Barotrauma.Items.Components.WifiComponent
---@return System.Boolean|nil
function CS.Barotrauma.LuaCs.Events.IEventModifyChatMessage.OnModifyMessagePredicate(message, senderRadio) end

---@private
---@param luaFunc userdata | { [System.String]: fun(...: System.Object): System.Object } | (fun(): userdata)
---@return Barotrauma.LuaCs.Events.IEventModifyChatMessage
function CS.Barotrauma.LuaCs.Events.IEventModifyChatMessage.GetLuaRunner(luaFunc) end
...
---@class Barotrauma.LuaCs.Events.IEventClientRawNetMessageReceived: Barotrauma.LuaCs.Events.IEvent
CS.Barotrauma.LuaCs.Events.IEventClientRawNetMessageReceived = {}
...
function CS.Barotrauma.LuaCs.Events.IEventClientRawNetMessageReceived.OnReceivedClientNetMessage(netMessage, clientPacketHeader, sender) end

---@private
---@param luaFunc userdata | { [System.String]: fun(...: System.Object): System.Object } | (fun(): userdata)
---@return Barotrauma.LuaCs.Events.IEventClientRawNetMessageReceived
function CS.Barotrauma.LuaCs.Events.IEventClientRawNetMessageReceived.GetLuaRunner(luaFunc) end


---@class Barotrauma.LuaCs.Events.IEventClientConnected: Barotrauma.LuaCs.Events.IEvent
CS.Barotrauma.LuaCs.Events.IEventClientConnected = {}

---@param client Barotrauma.Networking.Client
function CS.Barotrauma.LuaCs.Events.IEventClientConnected.OnClientConnected(client) end

---@private
---@param luaFunc userdata | { [System.String]: fun(...: System.Object): System.Object } | (fun(): userdata)
---@return Barotrauma.LuaCs.Events.IEventClientConnected
function CS.Barotrauma.LuaCs.Events.IEventClientConnected.GetLuaRunner(luaFunc) end


---@class Barotrauma.LuaCs.Events.IEventClientDisconnected: Barotrauma.LuaCs.Events.IEvent
CS.Barotrauma.LuaCs.Events.IEventClientDisconnected = {}

---@param client Barotrauma.Networking.Client
function CS.Barotrauma.LuaCs.Events.IEventClientDisconnected.OnClientDisconnected(client) end

---@private
---@param luaFunc userdata | { [System.String]: fun(...: System.Object): System.Object } | (fun(): userdata)
---@return Barotrauma.LuaCs.Events.IEventClientDisconnected
function CS.Barotrauma.LuaCs.Events.IEventClientDisconnected.GetLuaRunner(luaFunc) end


---@class Barotrauma.LuaCs.Events.IEventJobsAssigned: Barotrauma.LuaCs.Events.IEvent
CS.Barotrauma.LuaCs.Events.IEventJobsAssigned = {}

---@param unassignedClients userdata | { [System.Int32]: Barotrauma.Networking.Client } | (fun(): Barotrauma.Networking.Client)
function CS.Barotrauma.LuaCs.Events.IEventJobsAssigned.OnJobsAssigned(unassignedClients) end

---@private
---@param luaFunc userdata | { [System.String]: fun(...: System.Object): System.Object } | (fun(): userdata)
---@return Barotrauma.LuaCs.Events.IEventJobsAssigned
function CS.Barotrauma.LuaCs.Events.IEventJobsAssigned.GetLuaRunner(luaFunc) end
...
---@class Barotrauma.LuaCs.Events.IEventModifyChatMessage.LuaWrapper: Barotrauma.LuaCs.Events.IEvent.LuaWrapperBase, Barotrauma.LuaCs.Events.IEvent, Barotrauma.LuaCs.Events.IEventModifyChatMessage
CS.Barotrauma.LuaCs.Events.IEventModifyChatMessage.LuaWrapper = {}

---@param message Barotrauma.Networking.ChatMessage
---@param senderRadio Barotrauma.Items.Components.WifiComponent
---@return System.Boolean|nil
function CS.Barotrauma.LuaCs.Events.IEventModifyChatMessage.LuaWrapper.OnModifyMessagePredicate(message, senderRadio) end

do
---@param luaFuncs userdata | { [System.String]: fun(...: System.Object): System.Object } | (fun(): userdata)
---@return Barotrauma.LuaCs.Events.IEventModifyChatMessage.LuaWrapper
local __ctor = function(luaFuncs) end
CS.Barotrauma.LuaCs.Events.IEventModifyChatMessage.LuaWrapper = __ctor
CS.Barotrauma.LuaCs.Events.IEventModifyChatMessage.LuaWrapper.__new = __ctor
end
...
---@class Barotrauma.LuaCs.Events.IEventClientRawNetMessageReceived.LuaWrapper: Barotrauma.LuaCs.Events.IEvent.LuaWrapperBase, Barotrauma.LuaCs.Events.IEvent, Barotrauma.LuaCs.Events.IEventClientRawNetMessageReceived
CS.Barotrauma.LuaCs.Events.IEventClientRawNetMessageReceived.LuaWrapper = {}

---@param netMessage Barotrauma.Networking.IReadMessage
---@param clientPacketHeader Barotrauma.Networking.ClientPacketHeader
---@param sender Barotrauma.Networking.NetworkConnection
function CS.Barotrauma.LuaCs.Events.IEventClientRawNetMessageReceived.LuaWrapper.OnReceivedClientNetMessage(netMessage, clientPacketHeader, sender) end

do
---@param luaFuncs userdata | { [System.String]: fun(...: System.Object): System.Object } | (fun(): userdata)
---@return Barotrauma.LuaCs.Events.IEventClientRawNetMessageReceived.LuaWrapper
local __ctor = function(luaFuncs) end
CS.Barotrauma.LuaCs.Events.IEventClientRawNetMessageReceived.LuaWrapper = __ctor
CS.Barotrauma.LuaCs.Events.IEventClientRawNetMessageReceived.LuaWrapper.__new = __ctor
end

---@class Barotrauma.LuaCs.Events.IEventClientConnected.LuaWrapper: Barotrauma.LuaCs.Events.IEvent.LuaWrapperBase, Barotrauma.LuaCs.Events.IEvent, Barotrauma.LuaCs.Events.IEventClientConnected
CS.Barotrauma.LuaCs.Events.IEventClientConnected.LuaWrapper = {}

---@param client Barotrauma.Networking.Client
function CS.Barotrauma.LuaCs.Events.IEventClientConnected.LuaWrapper.OnClientConnected(client) end

do
---@param luaFuncs userdata | { [System.String]: fun(...: System.Object): System.Object } | (fun(): userdata)
---@return Barotrauma.LuaCs.Events.IEventClientConnected.LuaWrapper
local __ctor = function(luaFuncs) end
CS.Barotrauma.LuaCs.Events.IEventClientConnected.LuaWrapper = __ctor
CS.Barotrauma.LuaCs.Events.IEventClientConnected.LuaWrapper.__new = __ctor
end

---@class Barotrauma.LuaCs.Events.IEventClientDisconnected.LuaWrapper: Barotrauma.LuaCs.Events.IEvent.LuaWrapperBase, Barotrauma.LuaCs.Events.IEvent, Barotrauma.LuaCs.Events.IEventClientDisconnected
CS.Barotrauma.LuaCs.Events.IEventClientDisconnected.LuaWrapper = {}

---@param client Barotrauma.Networking.Client
function CS.Barotrauma.LuaCs.Events.IEventClientDisconnected.LuaWrapper.OnClientDisconnected(client) end

do
---@param luaFuncs userdata | { [System.String]: fun(...: System.Object): System.Object } | (fun(): userdata)
---@return Barotrauma.LuaCs.Events.IEventClientDisconnected.LuaWrapper
local __ctor = function(luaFuncs) end
CS.Barotrauma.LuaCs.Events.IEventClientDisconnected.LuaWrapper = __ctor
CS.Barotrauma.LuaCs.Events.IEventClientDisconnected.LuaWrapper.__new = __ctor
end

---@class Barotrauma.LuaCs.Events.IEventJobsAssigned.LuaWrapper: Barotrauma.LuaCs.Events.IEvent.LuaWrapperBase, Barotrauma.LuaCs.Events.IEvent, Barotrauma.LuaCs.Events.IEventJobsAssigned
CS.Barotrauma.LuaCs.Events.IEventJobsAssigned.LuaWrapper = {}

---@param unassignedClients userdata | { [System.Int32]: Barotrauma.Networking.Client } | (fun(): Barotrauma.Networking.Client)
function CS.Barotrauma.LuaCs.Events.IEventJobsAssigned.LuaWrapper.OnJobsAssigned(unassignedClients) end

do
---@param luaFuncs userdata | { [System.String]: fun(...: System.Object): System.Object } | (fun(): userdata)
---@return Barotrauma.LuaCs.Events.IEventJobsAssigned.LuaWrapper
local __ctor = function(luaFuncs) end
CS.Barotrauma.LuaCs.Events.IEventJobsAssigned.LuaWrapper = __ctor
CS.Barotrauma.LuaCs.Events.IEventJobsAssigned.LuaWrapper.__new = __ctor
end
