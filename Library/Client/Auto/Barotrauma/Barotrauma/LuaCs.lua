...
---@class Barotrauma.LuaCs.GUIUtil: System.Object
CS.Barotrauma.LuaCs.GUIUtil = {}

---@overload fun(parent: Barotrauma.GUILayoutGroup, split?: System.Boolean): userdata
---@param parent Barotrauma.GUIFrame
---@param split? System.Boolean
---@return userdata
function CS.Barotrauma.LuaCs.GUIUtil.CreateSidebars(parent, split) end

---@param parent Barotrauma.GUIFrame
---@return Barotrauma.GUILayoutGroup
function CS.Barotrauma.LuaCs.GUIUtil.CreateCenterLayout(parent) end

---@param parent Barotrauma.GUILayoutGroup
---@param adjustRatio Microsoft.Xna.Framework.Vector2
---@return Barotrauma.RectTransform
function CS.Barotrauma.LuaCs.GUIUtil.NewItemRectT(parent, adjustRatio) end

---@param parent Barotrauma.GUILayoutGroup
---@param adjustRatio Microsoft.Xna.Framework.Vector2
function CS.Barotrauma.LuaCs.GUIUtil.Spacer(parent, adjustRatio) end

---@param component Barotrauma.GUIComponent
---@param clearSelfFromParent? System.Boolean
function CS.Barotrauma.LuaCs.GUIUtil.ClearChildElements(component, clearSelfFromParent) end
...
function CS.Barotrauma.LuaCs.GUIUtil.Label(parent, str, font, adjustRatio) end

---@param parent Barotrauma.GUILayoutGroup
---@param range Microsoft.Xna.Framework.Vector2
---@param steps System.Int32
---@param labelFunc fun(arg: System.Single): System.String
---@param currentValue System.Single
---@param setter fun(obj: System.Single)
---@param tooltip Barotrauma.LocalizedString
---@param adjustRatio Microsoft.Xna.Framework.Vector2
---@return userdata
function CS.Barotrauma.LuaCs.GUIUtil.Slider(parent, range, steps, labelFunc, currentValue, setter, tooltip, adjustRatio) end

---@param parent Barotrauma.GUILayoutGroup
---@param label Barotrauma.LocalizedString
---@param tooltip Barotrauma.LocalizedString
---@param currentValue System.Boolean
---@param setter fun(obj: System.Boolean)
---@param adjustRatio Microsoft.Xna.Framework.Vector2
---@return Barotrauma.GUITickBox
function CS.Barotrauma.LuaCs.GUIUtil.Tickbox(parent, label, tooltip, currentValue, setter, adjustRatio) end

---@param v System.Single
---@return System.String
function CS.Barotrauma.LuaCs.GUIUtil.Percentage(v) end

---@param v System.Single
---@return System.Int32
function CS.Barotrauma.LuaCs.GUIUtil.Round(v) end

---@generic T : System.Enum
---@param __genericMethodMaker_T T
---@param parent Barotrauma.GUILayoutGroup
---@param textFunc fun(arg: T): Barotrauma.LocalizedString
---@param tooltipFunc fun(arg: T): Barotrauma.LocalizedString
---@param currentValue T
---@param setter fun(obj: T)
---@param adjustRatio Microsoft.Xna.Framework.Vector2
---@return Barotrauma.GUIDropDown
function CS.Barotrauma.LuaCs.GUIUtil.DropdownEnum(__genericMethodMaker_T, parent, textFunc, tooltipFunc, currentValue, setter, adjustRatio) end
...
---@return userdata | { [System.Int32]: Barotrauma.LuaCs.Data.ISettingBase } | (fun(): Barotrauma.LuaCs.Data.ISettingBase)
function CS.Barotrauma.LuaCs.ConfigService.GetDisplayableConfigs() end
...
---@class Barotrauma.LuaCs.LoggerService: System.Object, Barotrauma.LuaCs.ILoggerService, Barotrauma.LuaCs.IReusableService, Barotrauma.LuaCs.IService, System.IDisposable, Barotrauma.LuaCs.IClientLoggerService
---@field IsDisposed System.Boolean
---@field private _overlayFrame Barotrauma.GUIFrame
---@field private _textBlock Barotrauma.GUITextBlock
---@field private _showTimer System.Double
...
function CS.Barotrauma.LuaCs.LoggerService.CreateOverlay(message) end

function CS.Barotrauma.LuaCs.LoggerService.AddToGUIUpdateList() end

---@param message System.String
---@param time? System.Single
---@param duration? System.Single
function CS.Barotrauma.LuaCs.LoggerService.ShowErrorOverlay(message, time, duration) end
...
---@field private netReceives userdata | { [Barotrauma.LuaCs.NetworkingService.NetId]: fun(netMessage: Barotrauma.Networking.IReadMessage) } | (fun(): userdata)
...
function CS.Barotrauma.LuaCs.NetworkingService.OnServerConnected() end

---@private
function CS.Barotrauma.LuaCs.NetworkingService.ActivateNetVars() end

---@param netMessage Barotrauma.Networking.IReadMessage
---@param serverPacketHeader Barotrauma.Networking.ServerPacketHeader
function CS.Barotrauma.LuaCs.NetworkingService.OnReceivedServerNetMessage(netMessage, serverPacketHeader) end

---@private
function CS.Barotrauma.LuaCs.NetworkingService.SendSyncMessage() end
...
function CS.Barotrauma.LuaCs.NetworkingService.SendToServer(netMessage, deliveryMethod) end

---@param netMessage Barotrauma.Networking.IWriteMessage
---@param deliveryMethod? Barotrauma.Networking.DeliveryMethod
function CS.Barotrauma.LuaCs.NetworkingService.Send(netMessage, deliveryMethod) end

---@private
---@param netId Barotrauma.LuaCs.NetworkingService.NetId
function CS.Barotrauma.LuaCs.NetworkingService.RequestId(netId) end
...
---@private
---@param netMessage Barotrauma.Networking.IReadMessage
function CS.Barotrauma.LuaCs.NetworkingService.ReadIds(netMessage) end
...
---@overload fun(netIdString: System.String, callback: (fun(netMessage: Barotrauma.Networking.IReadMessage)))
---@overload fun(netIdGuid: System.Guid, callback: (fun(netMessage: Barotrauma.Networking.IReadMessage)))
...
---@package
---@param netId Barotrauma.LuaCs.NetworkingService.NetId
---@param callback fun(netMessage: Barotrauma.Networking.IReadMessage)
...
---@class Barotrauma.LuaCs.UIStylesCollection: Barotrauma.HashlessFile, Barotrauma.LuaCs.IUIStylesCollection, Barotrauma.LuaCs.IService, System.IDisposable
---@field Path Barotrauma.ContentPath
---@field IsDisposed System.Boolean
---@field private _fonts userdata | { [System.String]: Barotrauma.GUIFont } | (fun(): userdata)
---@field private _sprites userdata | { [System.String]: Barotrauma.GUISprite } | (fun(): userdata)
---@field private _spriteSheets userdata | { [System.String]: Barotrauma.GUISpriteSheet } | (fun(): userdata)
---@field private _cursors userdata | { [System.String]: Barotrauma.GUICursor } | (fun(): userdata)
---@field private _colors userdata | { [System.String]: Barotrauma.GUIColor } | (fun(): userdata)
---@field private _fakeFile Barotrauma.UIStyleFile
---@field private _storageService Barotrauma.LuaCs.IStorageService
---@field private _lock Barotrauma.LuaCs.AsyncReaderWriterLock
---@field private _isDisposed System.Int32
CS.Barotrauma.LuaCs.UIStylesCollection = {}

---@return Barotrauma.ContentPath
function CS.Barotrauma.LuaCs.UIStylesCollection.get_Path() end

---@param name System.String
---@return userdata
function CS.Barotrauma.LuaCs.UIStylesCollection.GetFont(name) end

---@param name System.String
---@return userdata
function CS.Barotrauma.LuaCs.UIStylesCollection.GetSprite(name) end

---@param name System.String
---@return userdata
function CS.Barotrauma.LuaCs.UIStylesCollection.GetSpriteSheet(name) end

---@param name System.String
---@return userdata
function CS.Barotrauma.LuaCs.UIStylesCollection.GetCursor(name) end

---@param name System.String
---@return userdata
function CS.Barotrauma.LuaCs.UIStylesCollection.GetColor(name) end

function CS.Barotrauma.LuaCs.UIStylesCollection.LoadFile() end

function CS.Barotrauma.LuaCs.UIStylesCollection.UnloadFile() end

function CS.Barotrauma.LuaCs.UIStylesCollection.Sort() end

function CS.Barotrauma.LuaCs.UIStylesCollection.Dispose() end

---@return System.Boolean
function CS.Barotrauma.LuaCs.UIStylesCollection.get_IsDisposed() end

---@private
---@param value System.Boolean
function CS.Barotrauma.LuaCs.UIStylesCollection.set_IsDisposed(value) end

do
---@param path Barotrauma.ContentPath
---@param storageService Barotrauma.LuaCs.IStorageService
---@return Barotrauma.LuaCs.UIStylesCollection
local __ctor = function(path, storageService) end
CS.Barotrauma.LuaCs.UIStylesCollection = __ctor
CS.Barotrauma.LuaCs.UIStylesCollection.__new = __ctor
end

---@class Barotrauma.LuaCs.UIStylesService: System.Object, Barotrauma.LuaCs.IUIStylesService, Barotrauma.LuaCs.IReusableService, Barotrauma.LuaCs.IService, System.IDisposable
---@field IsDisposed System.Boolean
---@field private _isDisposed System.Int32
---@field private _lock Barotrauma.LuaCs.AsyncReaderWriterLock
---@field private _storageService Barotrauma.LuaCs.IStorageService
---@field private _stylesCollectionFactory Barotrauma.LuaCs.IUIStylesCollection.IFactory
---@field private _stylesCollections userdata | { [userdata]: userdata | { [System.Int32]: Barotrauma.LuaCs.IUIStylesCollection } | (fun(): Barotrauma.LuaCs.IUIStylesCollection) } | (fun(): userdata)
CS.Barotrauma.LuaCs.UIStylesService = {}

function CS.Barotrauma.LuaCs.UIStylesService.Dispose() end

---@return System.Boolean
function CS.Barotrauma.LuaCs.UIStylesService.get_IsDisposed() end

---@private
---@param value System.Boolean
function CS.Barotrauma.LuaCs.UIStylesService.set_IsDisposed(value) end

---@return FluentResults.Result
function CS.Barotrauma.LuaCs.UIStylesService.Reset() end

---@param package Barotrauma.ContentPackage
---@param internalName System.String
---@param assetName System.String
---@return userdata
function CS.Barotrauma.LuaCs.UIStylesService.GetColor(package, internalName, assetName) end

---@param package Barotrauma.ContentPackage
---@param internalName System.String
---@param assetName System.String
---@return userdata
function CS.Barotrauma.LuaCs.UIStylesService.GetCursor(package, internalName, assetName) end

---@param package Barotrauma.ContentPackage
---@param internalName System.String
---@param assetName System.String
---@return userdata
function CS.Barotrauma.LuaCs.UIStylesService.GetFont(package, internalName, assetName) end

---@param package Barotrauma.ContentPackage
---@param internalName System.String
---@param assetName System.String
---@return userdata
function CS.Barotrauma.LuaCs.UIStylesService.GetSprite(package, internalName, assetName) end

---@param package Barotrauma.ContentPackage
---@param internalName System.String
---@param assetName System.String
---@return userdata
function CS.Barotrauma.LuaCs.UIStylesService.GetSpriteSheet(package, internalName, assetName) end

---@param resources userdata | { [System.Int32]: Barotrauma.LuaCs.Data.IStylesResourceInfo } | (fun(): Barotrauma.LuaCs.Data.IStylesResourceInfo)
---@return FluentResults.Result
function CS.Barotrauma.LuaCs.UIStylesService.LoadAssets(resources) end

---@param packages userdata | { [System.Int32]: Barotrauma.ContentPackage } | (fun(): Barotrauma.ContentPackage)
---@return FluentResults.Result
function CS.Barotrauma.LuaCs.UIStylesService.UnloadPackages(packages) end

---@param package Barotrauma.ContentPackage
---@return FluentResults.Result
function CS.Barotrauma.LuaCs.UIStylesService.UnloadPackage(package) end

---@return FluentResults.Result
function CS.Barotrauma.LuaCs.UIStylesService.UnloadAllPackages() end

do
---@param stylesCollectionFactory Barotrauma.LuaCs.IUIStylesCollection.IFactory
---@param storageService Barotrauma.LuaCs.IStorageService
---@return Barotrauma.LuaCs.UIStylesService
local __ctor = function(stylesCollectionFactory, storageService) end
CS.Barotrauma.LuaCs.UIStylesService = __ctor
CS.Barotrauma.LuaCs.UIStylesService.__new = __ctor
end

---@class Barotrauma.LuaCs.IClientLoggerService: Barotrauma.LuaCs.IReusableService, Barotrauma.LuaCs.IService, System.IDisposable
CS.Barotrauma.LuaCs.IClientLoggerService = {}

function CS.Barotrauma.LuaCs.IClientLoggerService.AddToGUIUpdateList() end

---@param message System.String
---@param time? System.Single
---@param duration? System.Single
function CS.Barotrauma.LuaCs.IClientLoggerService.ShowErrorOverlay(message, time, duration) end
...
---@return userdata | { [System.Int32]: Barotrauma.LuaCs.Data.ISettingBase } | (fun(): Barotrauma.LuaCs.Data.ISettingBase)
function CS.Barotrauma.LuaCs.IConfigService.GetDisplayableConfigs() end
...
---@class Barotrauma.LuaCs.ISettingsMenuSystem: Barotrauma.LuaCs.ISystem, Barotrauma.LuaCs.IReusableService, Barotrauma.LuaCs.IService, System.IDisposable
CS.Barotrauma.LuaCs.ISettingsMenuSystem = {}


---@class Barotrauma.LuaCs.IUIStylesCollection: Barotrauma.LuaCs.IService, System.IDisposable
---@field Path Barotrauma.ContentPath
CS.Barotrauma.LuaCs.IUIStylesCollection = {}

---@return Barotrauma.ContentPath
function CS.Barotrauma.LuaCs.IUIStylesCollection.get_Path() end

---@param name System.String
---@return userdata
function CS.Barotrauma.LuaCs.IUIStylesCollection.GetFont(name) end

---@param name System.String
---@return userdata
function CS.Barotrauma.LuaCs.IUIStylesCollection.GetSprite(name) end

---@param name System.String
---@return userdata
function CS.Barotrauma.LuaCs.IUIStylesCollection.GetSpriteSheet(name) end

---@param name System.String
---@return userdata
function CS.Barotrauma.LuaCs.IUIStylesCollection.GetCursor(name) end

---@param name System.String
---@return userdata
function CS.Barotrauma.LuaCs.IUIStylesCollection.GetColor(name) end

---@package
function CS.Barotrauma.LuaCs.IUIStylesCollection.LoadFile() end

---@package
function CS.Barotrauma.LuaCs.IUIStylesCollection.UnloadFile() end

---@package
function CS.Barotrauma.LuaCs.IUIStylesCollection.Sort() end


---@class Barotrauma.LuaCs.IUIStylesService: Barotrauma.LuaCs.IReusableService, Barotrauma.LuaCs.IService, System.IDisposable
CS.Barotrauma.LuaCs.IUIStylesService = {}

---@param package Barotrauma.ContentPackage
---@param internalName System.String
---@param assetName System.String
---@return userdata
function CS.Barotrauma.LuaCs.IUIStylesService.GetColor(package, internalName, assetName) end

---@param package Barotrauma.ContentPackage
---@param internalName System.String
---@param assetName System.String
---@return userdata
function CS.Barotrauma.LuaCs.IUIStylesService.GetCursor(package, internalName, assetName) end

---@param package Barotrauma.ContentPackage
---@param internalName System.String
---@param assetName System.String
---@return userdata
function CS.Barotrauma.LuaCs.IUIStylesService.GetFont(package, internalName, assetName) end

---@param package Barotrauma.ContentPackage
---@param internalName System.String
---@param assetName System.String
---@return userdata
function CS.Barotrauma.LuaCs.IUIStylesService.GetSprite(package, internalName, assetName) end

---@param package Barotrauma.ContentPackage
---@param internalName System.String
---@param assetName System.String
---@return userdata
function CS.Barotrauma.LuaCs.IUIStylesService.GetSpriteSheet(package, internalName, assetName) end

---@param resources userdata | { [System.Int32]: Barotrauma.LuaCs.Data.IStylesResourceInfo } | (fun(): Barotrauma.LuaCs.Data.IStylesResourceInfo)
---@return FluentResults.Result
function CS.Barotrauma.LuaCs.IUIStylesService.LoadAssets(resources) end

---@param packages userdata | { [System.Int32]: Barotrauma.ContentPackage } | (fun(): Barotrauma.ContentPackage)
---@return FluentResults.Result
function CS.Barotrauma.LuaCs.IUIStylesService.UnloadPackages(packages) end

---@param package Barotrauma.ContentPackage
---@return FluentResults.Result
function CS.Barotrauma.LuaCs.IUIStylesService.UnloadPackage(package) end

---@return FluentResults.Result
function CS.Barotrauma.LuaCs.IUIStylesService.UnloadAllPackages() end


---@class Barotrauma.LuaCs.ModsControlsSettingsMenu: Barotrauma.LuaCs.ModsSettingsMenuBase, System.IDisposable
CS.Barotrauma.LuaCs.ModsControlsSettingsMenu = {}

---@protected
function CS.Barotrauma.LuaCs.ModsControlsSettingsMenu.DisposeInternal() end

function CS.Barotrauma.LuaCs.ModsControlsSettingsMenu.ApplyInstalledModChanges() end

do
---@param contentFrame Barotrauma.GUIFrame
---@param packageManagementService Barotrauma.LuaCs.IPackageManagementService
---@param configService Barotrauma.LuaCs.IConfigService
---@param settingsMenuInstance Barotrauma.SettingsMenu
---@return Barotrauma.LuaCs.ModsControlsSettingsMenu
local __ctor = function(contentFrame, packageManagementService, configService, settingsMenuInstance) end
CS.Barotrauma.LuaCs.ModsControlsSettingsMenu = __ctor
CS.Barotrauma.LuaCs.ModsControlsSettingsMenu.__new = __ctor
end

---@class Barotrauma.LuaCs.ModsGameplaySettingsMenu: Barotrauma.LuaCs.ModsSettingsMenuBase, System.IDisposable
---@field private _settingsInstancesGameplay userdata | { [System.Int32]: Barotrauma.LuaCs.Data.ISettingBase } | (fun(): Barotrauma.LuaCs.Data.ISettingBase)
---@field private _modCategoryDisplayGroup Barotrauma.GUILayoutGroup
---@field private _settingsDisplayGroup Barotrauma.GUILayoutGroup
---@field private _selectedSearchQuery System.String
---@field private _selectedContentPackage Barotrauma.ContentPackage
---@field private _selectedCategory System.String
CS.Barotrauma.LuaCs.ModsGameplaySettingsMenu = {}

---@protected
function CS.Barotrauma.LuaCs.ModsGameplaySettingsMenu.DisposeInternal() end

function CS.Barotrauma.LuaCs.ModsGameplaySettingsMenu.ApplyInstalledModChanges() end
...
---@param configService Barotrauma.LuaCs.IConfigService
---@param settingsMenuInstance Barotrauma.SettingsMenu
---@return Barotrauma.LuaCs.ModsGameplaySettingsMenu
local __ctor = function(contentFrame, packageManagementService, configService, settingsMenuInstance) end
CS.Barotrauma.LuaCs.ModsGameplaySettingsMenu = __ctor
CS.Barotrauma.LuaCs.ModsGameplaySettingsMenu.__new = __ctor
end

---@class Barotrauma.LuaCs.ModsSettingsMenuBase: System.Object, System.IDisposable
---@field ContentFrame Barotrauma.GUIFrame
---@field protected PackageManagementService Barotrauma.LuaCs.IPackageManagementService
---@field protected ConfigService Barotrauma.LuaCs.IConfigService
---@field protected SettingsMenuInstance Barotrauma.SettingsMenu
---@field protected NewValuesCache userdata | { [Barotrauma.LuaCs.Data.ISettingBase]: System.String } | (fun(): userdata)
CS.Barotrauma.LuaCs.ModsSettingsMenuBase = {}

---@protected
function CS.Barotrauma.LuaCs.ModsSettingsMenuBase.DisposeInternal() end

function CS.Barotrauma.LuaCs.ModsSettingsMenuBase.ApplyInstalledModChanges() end

function CS.Barotrauma.LuaCs.ModsSettingsMenuBase.Dispose() end
...
---@param configService Barotrauma.LuaCs.IConfigService
---@param settingsMenuInstance Barotrauma.SettingsMenu
---@return Barotrauma.LuaCs.ModsSettingsMenuBase
local __ctor = function(contentFrame, packageManagementService, configService, settingsMenuInstance) end
CS.Barotrauma.LuaCs.ModsSettingsMenuBase = __ctor
CS.Barotrauma.LuaCs.ModsSettingsMenuBase.__new = __ctor
end

---@class Barotrauma.LuaCs.SettingsMenuSystem: System.Object, Barotrauma.LuaCs.ISettingsMenuSystem, Barotrauma.LuaCs.ISystem, Barotrauma.LuaCs.IReusableService, Barotrauma.LuaCs.IService, System.IDisposable
---@field IsDisposed System.Boolean
---@field private _controlsMenuInstance Barotrauma.LuaCs.ModsControlsSettingsMenu
---@field private _gameplayMenuInstance Barotrauma.LuaCs.ModsGameplaySettingsMenu
---@field private _gameplayContentFrame Barotrauma.GUIFrame
---@field private _controlsContentFrame Barotrauma.GUIFrame
---@field private _settingsMenuInstance Barotrauma.SettingsMenu
---@field private _harmony HarmonyLib.Harmony
---@field private _packageManagementService Barotrauma.LuaCs.IPackageManagementService
---@field private _configService Barotrauma.LuaCs.IConfigService
---@field private _isDisposed System.Int32
---@field private SystemInstance Barotrauma.LuaCs.SettingsMenuSystem
CS.Barotrauma.LuaCs.SettingsMenuSystem = {}

---@private
---@param __instance Barotrauma.SettingsMenu
function CS.Barotrauma.LuaCs.SettingsMenuSystem.SettingsMenu_CreateModsTab_Post(__instance) end

---@private
---@param __instance Barotrauma.SettingsMenu
function CS.Barotrauma.LuaCs.SettingsMenuSystem.CreateSettingsMenu(__instance) end

---@private
---@param tab Barotrauma.SettingsMenu.Tab
---@param settingsMenuInstance Barotrauma.SettingsMenu
---@param settingsMenuTabName System.String
---@param settingMenuHoverTextIdent System.String
---@return Barotrauma.GUIFrame
function CS.Barotrauma.LuaCs.SettingsMenuSystem.CreateNewContentTab(tab, settingsMenuInstance, settingsMenuTabName, settingMenuHoverTextIdent) end

---@private
function CS.Barotrauma.LuaCs.SettingsMenuSystem.SettingsMenu_ApplyInstalledModChanges_Post() end

---@private
function CS.Barotrauma.LuaCs.SettingsMenuSystem.DisposeMenuFrames() end

function CS.Barotrauma.LuaCs.SettingsMenuSystem.Dispose() end

---@return System.Boolean
function CS.Barotrauma.LuaCs.SettingsMenuSystem.get_IsDisposed() end

---@private
---@param value System.Boolean
function CS.Barotrauma.LuaCs.SettingsMenuSystem.set_IsDisposed(value) end

---@return FluentResults.Result
function CS.Barotrauma.LuaCs.SettingsMenuSystem.Reset() end

do
---@param packageManagementService Barotrauma.LuaCs.IPackageManagementService
---@param configService Barotrauma.LuaCs.IConfigService
---@return Barotrauma.LuaCs.SettingsMenuSystem
local __ctor = function(packageManagementService, configService) end
CS.Barotrauma.LuaCs.SettingsMenuSystem = __ctor
CS.Barotrauma.LuaCs.SettingsMenuSystem.__new = __ctor
end
...
function CS.Barotrauma.LuaCs.HarmonyEventPatchesService.GameSession_StartRound_Post() end
...
---@param __instance Barotrauma.Screen
function CS.Barotrauma.LuaCs.HarmonyEventPatchesService.MainMenuScreen_StartGame_Pre(__instance) end

---@param __instance Barotrauma.Screen
function CS.Barotrauma.LuaCs.HarmonyEventPatchesService.MainMenuScreen_LoadGame_Pre(__instance) end

---@param __instance Barotrauma.Screen
function CS.Barotrauma.LuaCs.HarmonyEventPatchesService.MutableWorkshopMenu_Apply_Post(__instance) end
...
function CS.Barotrauma.LuaCs.HarmonyEventPatchesService.GameClient_ReadDataMessage_Pre(inc) end

---@param __instance Barotrauma.Screen
function CS.Barotrauma.LuaCs.HarmonyEventPatchesService.SubEditorScreen_Selected_Post(__instance) end

---@param deltaTime System.Double
function CS.Barotrauma.LuaCs.HarmonyEventPatchesService.PlayerInput_Update_Pre(deltaTime) end

---@param command Barotrauma.Identifier
---@param __result System.Boolean
---@return System.Boolean
function CS.Barotrauma.LuaCs.HarmonyEventPatchesService.DebugConsole_IsCommandPermitted(command, __result) end
...
---@field private _stylesParserService userdata
---@field private _operationsLock Barotrauma.LuaCs.AsyncReaderWriterLock
---@field private _isDisposed System.Int32
...
---@param stylesParserService userdata
---@param logger Barotrauma.LuaCs.ILoggerService
---@return Barotrauma.LuaCs.ModConfigService
local __ctor = function(storageService, assemblyParserService, luaScriptParserService, configParserService, stylesParserService, logger) end
...
---@field private _pluginManagementService Barotrauma.LuaCs.IPluginManagementService
---@field private _commandsService Barotrauma.LuaCs.IConsoleCommandsService
---@field private _uiStylesService Barotrauma.LuaCs.IUIStylesService
...
---@param configService Barotrauma.LuaCs.IConfigService
---@param commandsService Barotrauma.LuaCs.IConsoleCommandsService
---@param uiStylesService Barotrauma.LuaCs.IUIStylesService
---@param runConfig Barotrauma.LuaCs.Data.IPackageManagementServiceConfig
---@return Barotrauma.LuaCs.PackageManagementService
local __ctor = function(logger, modConfigService, luaScriptManagementService, pluginManagementService, configService, commandsService, uiStylesService, runConfig) end
...
---@param netMessage Barotrauma.Networking.IReadMessage
function CS.Barotrauma.LuaCs.NetMessageReceived.Invoke(netMessage) end

---@param netMessage Barotrauma.Networking.IReadMessage
---@param callback fun(ar: System.IAsyncResult)
---@param object System.Object
---@return System.IAsyncResult
function CS.Barotrauma.LuaCs.NetMessageReceived.BeginInvoke(netMessage, callback, object) end
...
---@overload fun(netId: System.Guid, action: (fun(netMessage: Barotrauma.Networking.IReadMessage)))
---@param netId System.String
---@param action fun(netMessage: Barotrauma.Networking.IReadMessage)
function CS.Barotrauma.LuaCs.INetworkingService.Receive(netId, action) end

---@param netMessage Barotrauma.Networking.IWriteMessage
---@param deliveryMethod? Barotrauma.Networking.DeliveryMethod
function CS.Barotrauma.LuaCs.INetworkingService.SendToServer(netMessage, deliveryMethod) end
...
---@private
function CS.Barotrauma.LuaCs.DefaultLuaRegistrar.RegisterClient() end
...
function CS.Barotrauma.LuaCs.LuaGame.get_Client() end

---@return System.Boolean
function CS.Barotrauma.LuaCs.LuaGame.get_Paused() end

---@return System.Byte
function CS.Barotrauma.LuaCs.LuaGame.get_SessionId() end

---@return System.Byte
function CS.Barotrauma.LuaCs.LuaGame.get_MyID() end

---@return Barotrauma.ChatMode
function CS.Barotrauma.LuaCs.LuaGame.get_ActiveChatMode() end

---@return Barotrauma.ChatBox
function CS.Barotrauma.LuaCs.LuaGame.get_ChatBox() end

---@return Barotrauma.Sounds.SoundManager
function CS.Barotrauma.LuaCs.LuaGame.get_SoundManager() end

---@return Barotrauma.Lights.LightManager
function CS.Barotrauma.LuaCs.LuaGame.get_LightManager() end

---@return Barotrauma.SubEditorScreen
function CS.Barotrauma.LuaCs.LuaGame.get_SubEditorScreen() end

---@return Barotrauma.MainMenuScreen
function CS.Barotrauma.LuaCs.LuaGame.get_MainMenuScreen() end

---@return Barotrauma.Particles.ParticleManager
function CS.Barotrauma.LuaCs.LuaGame.get_ParticleManager() end

---@return System.Boolean
function CS.Barotrauma.LuaCs.LuaGame.get_IsSubEditor() end
...
---@class Barotrauma.LuaCs.UIStylesCollection.Factory: System.Object, Barotrauma.LuaCs.IUIStylesCollection.IFactory, Barotrauma.LuaCs.IService, System.IDisposable
---@field IsDisposed System.Boolean
CS.Barotrauma.LuaCs.UIStylesCollection.Factory = {}

---@param info Barotrauma.LuaCs.Data.IStylesResourceInfo
---@param storageService Barotrauma.LuaCs.IStorageService
---@return userdata | (fun(): Barotrauma.LuaCs.IUIStylesCollection)
function CS.Barotrauma.LuaCs.UIStylesCollection.Factory.CreateInstance(info, storageService) end

function CS.Barotrauma.LuaCs.UIStylesCollection.Factory.Dispose() end

---@return System.Boolean
function CS.Barotrauma.LuaCs.UIStylesCollection.Factory.get_IsDisposed() end

do
---@return Barotrauma.LuaCs.UIStylesCollection.Factory
local __ctor = function() end
CS.Barotrauma.LuaCs.UIStylesCollection.Factory = __ctor
CS.Barotrauma.LuaCs.UIStylesCollection.Factory.__new = __ctor
end

---@class Barotrauma.LuaCs.IUIStylesCollection.IFactory: Barotrauma.LuaCs.IService, System.IDisposable
CS.Barotrauma.LuaCs.IUIStylesCollection.IFactory = {}

---@param info Barotrauma.LuaCs.Data.IStylesResourceInfo
---@param storageService Barotrauma.LuaCs.IStorageService
---@return userdata | (fun(): Barotrauma.LuaCs.IUIStylesCollection)
function CS.Barotrauma.LuaCs.IUIStylesCollection.IFactory.CreateInstance(info, storageService) end
