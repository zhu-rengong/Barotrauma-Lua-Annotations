...
Sounds = {
    LowpassFilter = CS.Barotrauma.Sounds.LowpassFilter,
    HighpassFilter = CS.Barotrauma.Sounds.HighpassFilter,
    BandpassFilter = CS.Barotrauma.Sounds.BandpassFilter,
    NotchFilter = CS.Barotrauma.Sounds.NotchFilter,
    LowShelfFilter = CS.Barotrauma.Sounds.LowShelfFilter,
    HighShelfFilter = CS.Barotrauma.Sounds.HighShelfFilter,
    PeakFilter = CS.Barotrauma.Sounds.PeakFilter,
}

SpriteEffects = CS.Microsoft.Xna.Framework.Graphics.SpriteEffects

SoundPlayer = CS.Barotrauma.SoundPlayer
SoundPrefab = CS.Barotrauma.SoundPrefab
BackgroundMusic = CS.Barotrauma.BackgroundMusic
GUISound = CS.Barotrauma.GUISound
DamageSound = CS.Barotrauma.DamageSound
WaterRenderer = CS.Barotrauma.WaterRenderer

TextureLoader = CS.Barotrauma.TextureLoader
Sprite = CS.Barotrauma.Sprite
PlayerInput = CS.Barotrauma.PlayerInput

Keys = CS.Microsoft.Xna.Framework.Input.Keys

GUI = CS.Barotrauma.GUI
GUI = {
    GUI = CS.Barotrauma.GUI,
    Style = CS.Barotrauma.GUIStyle,
    Component = CS.Barotrauma.GUIComponent,
    RectTransform = CS.Barotrauma.RectTransform,
    LayoutGroup = CS.Barotrauma.GUILayoutGroup,
    Button = CS.Barotrauma.GUIButton,
    TextBox = CS.Barotrauma.GUITextBox,
    Canvas = CS.Barotrauma.GUICanvas,
    Frame = CS.Barotrauma.GUIFrame,
    TextBlock = CS.Barotrauma.GUITextBlock,
    TickBox = CS.Barotrauma.GUITickBox,
    Image = CS.Barotrauma.GUIImage,
    ListBox = CS.Barotrauma.GUIListBox,
    ScrollBar = CS.Barotrauma.GUIScrollBar,
    DropDown = CS.Barotrauma.GUIDropDown,
    NumberInput = CS.Barotrauma.GUINumberInput,
    MessageBox = CS.Barotrauma.GUIMessageBox,
    ColorPicker = CS.Barotrauma.GUIColorPicker,
    ProgressBar = CS.Barotrauma.GUIProgressBar,
    CustomComponent = CS.Barotrauma.GUICustomComponent,
    ScissorComponent = CS.Barotrauma.GUIScissorComponent,
    VideoPlayer = CS.Barotrauma.VideoPlayer,
    Graph = CS.Barotrauma.Graph,
    SerializableEntityEditor = CS.Barotrauma.SerializableEntityEditor,
    SlideshowPlayer = CS.Barotrauma.SlideshowPlayer,
    CreditsPlayer = CS.Barotrauma.CreditsPlayer,
    DragHandle = CS.Barotrauma.GUIDragHandle,
    ContextMenu = CS.Barotrauma.GUIContextMenu,
    ContextMenuOption = CS.Barotrauma.ContextMenuOption,

    Screen = CS.Barotrauma.Screen,

    Anchor = CS.Barotrauma.Anchor,
    Alignment = CS.Barotrauma.Alignment,
    Pivot = CS.Barotrauma.Pivot,
    SoundType = CS.Barotrauma.GUISoundType,
    CursorState = CS.Barotrauma.CursorState,

    GUIStyle = CS.Barotrauma.GUIStyle,
}
